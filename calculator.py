...
label = Label(window, textvariable=equation_label, font=("consolas", 20), bg="gray", width=27, height=2)
label.pack()
...
plus = Button(frame, text="+", height=4, width=7, font=35, command=lambda: button_press("+"))
plus.grid(row=0, column=3)

minus = Button(frame, text="-", height=4, width=7, font=35, command=lambda: button_press("-"))
minus.grid(row=1, column=3)

multiply = Button(frame, text="*", height=4, width=7, font=35, command=lambda: button_press("*"))
multiply.grid(row=2, column=3)

divide = Button(frame, text="/", height=4, width=7, font=35, command=lambda: button_press("/"))
...
clears = Button(window, text="AC", height=2, width=36, font=35, command=clear)
clears.pack()
